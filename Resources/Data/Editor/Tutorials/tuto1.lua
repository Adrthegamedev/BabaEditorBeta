local tuto_subcontents =
{
	intro =
	{
		...
		slide1 = 
		{
			-- 1. Introduction
			init = function()
				text_tuto("tutorial_intro_1a",0,-8,true,nil,{1,3})
				text_tuto("tutorial_intro_1b",0,-7,true)
				text_tuto("tutorial_intro_1c",0,-1,true)
				
				button_tuto("skip","tutorial_skip",-5,6,8,4)
				button_tuto("cont","tutorial_continue",5,6,8,4)
			end,
		...
		slide2 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_intro_2a",0,-9,true)
		...
		slide3 = 
		{
			...
			init = function()
				...
				button_tuto("cont","tutorial_continue",0,7,16,4)
			end,
		...
		slide5 = 
		{
			...
			init = function()
				...
				button_tuto("cont","tutorial_continue",0,2,8,4)
			end,
		...
		slide13 = 
		{
			...
			init = function()
				text_tuto("tutorial_intro_13a",0,-7,true,nil,nil,screenw * 0.6)

	...
	tutorial4 =
	{
		...
		slide3 = 
		{
			...
			init = function()
				...
				button_tuto("cont","tutorial_continue",0,-1,8,4)
			end,
		...
		slide4 = 
		{
			...
			init = function()
				...
				text_tuto({"tutorial_4_4a","tutorial_4_4a_gpad"},0,1,true,nil,nil,screenw * 0.6)
				...
				button_tuto("cont","tutorial_continue",0,6,8,4)
			end,
		...
		slide5 = 
		{
			-- 5. Changing viewmode
			init = function()
				text_tuto("tutorial_4_5a",0,-1,true,nil,nil,screenw * 0.6)
				
				tuto_pointer(10,-7)
				
				button_tuto("cont","tutorial_continue",0,7,8,4)
			end,
		...
		slide6 = 
		{
			...
			init = function()
				...
				text_tuto({"tutorial_4_6a","tutorial_4_6a_gpad"},0,0,true,nil,nil,screenw * 0.6)
		...
		slide7 = 
		{
			...
			init = function()
				...
				text_tuto({"tutorial_4_7a","tutorial_4_7a_gpad"},0,2,true,nil,nil,screenw * 0.6)
		...
		slide8 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_4_8a",0,3.5,true,nil,nil,screenw * 0.75)
		...
		slide10 = 
		{
			...
			init = function()
				...
				text_tuto({"tutorial_4_10a","tutorial_4_10a_gpad"},0,1,true,nil,nil,screenw * 0.6)
		...
		slide11 = 
		{
			...
			init = function()
				...
				text_tuto({"tutorial_4_11a","tutorial_4_11a_gpad"},0,-1,true,nil,nil,screenw * 0.6)
		...
		slide12 = 
		{
			-- 12. Edit object data
			init = function()
				text_tuto({"tutorial_4_12a","tutorial_4_12a_gpad"},0,0,true,nil,nil,screenw * 0.6)
		...
		slide13 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_4_13a",0,3,true)
		...
		slide14 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_4_14a",0,3,true,nil,nil,screenw * 0.6)
		...
		slide15 = 
		{
			-- 15. Dragging objects
			init = function()
				text_tuto({"tutorial_4_15a","tutorial_4_15a_gpad"},0,1,true,nil,nil,screenw * 0.6)

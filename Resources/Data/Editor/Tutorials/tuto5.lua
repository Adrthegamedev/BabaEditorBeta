	...
	tutorial5 =
	{
		...
		slide5 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_5_5a",-8,-5,true,nil,nil,screenw * 0.4)
		...
		slide11 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_5_11a",-8,-5,true,nil,nil,screenw * 0.4)
		...
		slide13 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_5_13a",0,-8,true,nil,nil,screenw * 0.6)
		...
		slide14 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_5_14a",0,-8,true,nil,nil,screenw * 0.6)
		...
		slide15 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_5_15a",0,-8,true,nil,nil,screenw * 0.6)
		...
		slide17 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_5_17a",0,-8,true,nil,nil,screenw * 0.6)
		...
		slide18 = 
		{
			...
			init = function()
				...
				text_tuto("tutorial_5_18a",0,-8,true,nil,nil,screenw * 0.6)
